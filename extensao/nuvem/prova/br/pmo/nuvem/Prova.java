 ...
 *
 * <p><b>POR QUE NAO JUNIT.</b> O nucleo do conector de nuvem nao depende de
 * nada fora do JDK, e isso e' um bem que se perde na primeira dependencia
 * adicionada: passar a exigir JUnit no classpath significaria baixar jar para
 * provar uma conta de caminho ou de conflito. O mesmo arcabouco provou o DLP
 * (br.pmo.dlp) com 226 asseveracoes; aqui ele e' copiado para nao acoplar
 * pacotes que sao entregas independentes.
 *
...
public final class Prova {
  ...
  public static void igual(String oQue, Object esperado, Object obtido) {
    ...
    if (bate) {
      ...
      FALHAS.add(secaoAtual + " :: " + oQue + " (esperado " + esperado
          + ", obtido " + obtido + ")");
    }
  }
